...
<center>   
<form class="form-group" action="index.php" method="GET" name="selectOrder">
    ...
    <input class="btn btn-default" type="submit" value="View All" onClick="location.href = 'index.php'" />
